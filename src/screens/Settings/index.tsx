    ...
    const editingMode = () => {
        return (
                ...
                >
                        ...
                        <View style={{ flexDirection: 'row', marginBottom: dp(16), justifyContent: 'space-evenly'}}>
                            <Button label={'Закрыть'} color={'blue'} width={dp(140)} height={dp(40)} fontSize={dp(16)} fontWeight={"600"} onClick={handleClosePress}/>
                            <Button label={'Сохранить'} color={'blue'} width={dp(140)} height={dp(40)} fontSize={dp(16)} fontWeight={"600"} disabled={loading} onClick={saveUserDate} showLoading={loading} />
                        </View>
                </BottomSheet>
        )
    }
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1}}>
            ...
            <View style={styles.container}>
                <View style={styles.profileCard}>
                    <TouchableOpacity style={{ alignSelf: 'flex-end'}} onPress={() => setEditing(true)}>
                        <Edit3
                            height={dp(20)}
                            width={dp(20)}
                            stroke={'#000000'}
                    ...
                    <Text style={{...styles.text, marginTop: dp(18)}}>{formatPhoneNumber(phone)}</Text>
                    <Text style={{...styles.text}}>{email}</Text>
                    <View style={styles.balance}>
                        <Text style={styles.balanceText}>{store && store.balance ? store.balance : 0}</Text>
                        <Image source={require('../../assets/icons/onvi_black.png')} style={styles.balanceIcon}/>
                    </View>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity style={styles.btnAbout} onPress={onAboutButtonHandle}>
                ...
                <View style={styles.footerBtns}>
                    <TouchableOpacity style={styles.btnDelete}>
                        <Text style={{ fontSize: dp(10), fontWeight: '400', color: '#AFAEAE'}}>УДАЛИТЬ АККАУНТ</Text>
                    </TouchableOpacity>
