        ...
        return (
            <BottomSheetScrollView contentContainerStyle={{...styles.container, backgroundColor: theme.mainColor}} nestedScrollEnabled={true} scrollEnabled={isOpened}>
                    ...
                    <ScrollView style={{paddingBottom: verticalScale(100)}}>
                        {order.prices.map((price: Price, i: number) => <View key={price.id}>
                            <ExpandableView color={colors[i]}  data={price} onSelect={() => onSelect(price.name, price.cost)} >
                                <View style={{ flexDirection: 'column', paddingBottom: dp(40)}}>
                                <Text style={{ fontSize: dp(9), fontWeight: '600', color: '#000', marginBottom: dp(10)}}>ВРЕМЯ МОЙКИ?</Text>
                                <ActionButton
                                    style={{
                                ...
                                />
                                <Text style={{ fontSize: dp(9), fontWeight: '600', color: '#000', marginTop: dp(10), marginBottom: dp(10)}}>ЧТО ВХОДИТ?</Text>
        ...
        <BottomSheetScrollView contentContainerStyle={{ ...styles.container, backgroundColor: theme.mainColor}} nestedScrollEnabled={true} scrollEnabled={isOpened}>
                ...
                >
                    <View style={{
                        ...
                        }}>Способ измерения</Text>
                        <FilterList data={measureTypeData} width={horizontalScale(53)} backgroundColor={"#BFFA00"} />
                    </View>
                ...
                <View style={{justifyContent: 'space-evenly', alignItems: "center", flex: 1, paddingTop: dp(20), paddingBottom: dp(90)}}>
