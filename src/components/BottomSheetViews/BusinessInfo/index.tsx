...
const BusinessInfo = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        ...
                        <Image source={require('../../../assets/emojies/thinking.png')} style={{ width: dp(40), height: dp(40), resizeMode: 'contain'}} />
                        ...
                        <View style={styles.actionButtons}>
                            <View style={{ paddingRight: dp(14) }}>
                                <Button onClick={() => setModalVisible(false)} label="Назад" color="blue" width={129} height={42} fontSize={18} fontWeight="600" />
                            </View>
                            <Button onClick={forceForward} label="Все Ок" color="blue" width={129} height={42} fontSize={18} fontWeight="600" />
                        </View>
                    </View>
                </View>
            </Modal>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', paddingTop: dp(10)}}>
                {
            ...
            <View style={{alignSelf: 'center', paddingTop: dp(36)}}>
                <Button color={"blue"} label={"Моемся"} width={187} height={57} fontSize={24} fontWeight={"600"} onClick={() => modalCallback()} />
            </View>
        </View>
    )
}
