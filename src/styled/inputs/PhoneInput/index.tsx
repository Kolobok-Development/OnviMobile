        ...
        <View style={{ height: dp(60), justifyContent: 'center' }}>
            <View style={{alignSelf: 'center', paddingTop: 30}}>
                <TextInput 
                    ...
                    value={phoneNumber.startsWith('+7') ? ("+7" + phoneNumber.substring(2)) : ("+7 " + phoneNumber)}
                    onChangeText={handleChangeText}
                    keyboardType="phone-pad"
                    style={{ backgroundColor: "rgba(216, 217, 221, 1)", width:  dp(285), borderRadius: 25, height: dp(50), textAlign: 'center', alignItems: 'center', fontSize: dp(24), color: BLACK }} 
                />
            </View>
        </View>
    )
